...
public class GameState {
	...
	/** Sell button on the sell screen: the same checks sellCargo makes, done before asking how many (which divides by the cargo count). */
	public void sellPick(TradeItem item) {
